...
## 0. ⭐ Čo je nové vo v4.2 (15.09.2026) — čítaj PRVÉ

**Rozhodnutie Martina:** *„mail nech je priamočiarejší — čo ponúkame a či by mali záujem."*

v4.0 skrátila mail na 70 slov, ale nechala ho **opisný a opatrný**. Druhý odsek opisoval mechanizmus („vieme vám pridať poradcu, ktorý by…"), tretí sa pýtal okľukou („dáva to u vás zmysel, alebo som mimo?"). Príjemca po prečítaní vedel, čo sme si všimli, ale nie vždy, **čo si u nás môže objednať** a **na čo má odpovedať**.

Čo sa mení oproti v4.1:

| | v4.1 (do 14.09.) | **v4.2 (od 15.09.)** |
|---|---|---|
| Odsek 2 — sloveso | „vieme vám postaviť / pridať" (schopnosť) | **„postavíme vám / spravíme vám" (ponuka)** |
| Odsek 2 — predmet | opis mechanizmu („poradcu, ktorý by…") | **pomenovaná vec („chatbota", „rezervačný systém", „nový web")** |
| Slovo „chatbot" v tele | obchádzalo sa | **povolené a odporúčané** (v predmete ostáva zakázané, §5) |
| Odsek 3 — CTA | nepriama („dáva to zmysel, alebo som mimo?") | **priama otázka na záujem („Máte o to záujem?")** |
| CTA predpokladajúce hovor | vo výbere boli | **zrušené** — pri prvom kontakte pýtame záujem, nie kalendár |

**Prečo to ide, hoci je strop stále 70 slov:** priama CTA je o 4–6 slov kratšia než tie staré („Máte o to záujem?" = 4 slová vs. „Mám poslať, ako by to vyzeralo u vás? Bez hovoru." = 9). Ušetrené slová idú do druhého odseku, aby sa ponuka dala pomenovať konkrétne. Mail sa teda nepredlžuje, len presúva váhu z okolkovania na obsah.

**Čo sa NEMENÍ:** pravidlá **H** a **I** (§1), strop 70 slov a tri odseky (§4), zákaz čísel a cien (§1 B), povinný podpis (§4), a hlavne **§8.5** — priamosť sa týka DRUHÉHO a TRETIEHO odseku. Prvý odsek ostáva postrehom o ICH zákazníkovi, nie súdom o ich práci. *„Postavíme vám rezervačný systém"* je priamosť; *„máte to zle vyriešené"* je hrubosť. To nie je to isté.

**Čo tým riskujeme (aby to bolo napísané):** audit z 01.09. (§0.1) ukázal, že všetky štyri pozitívne reakcie prišli na konkrétny postreh podaný **teplo**. Priama otázka na záujem je efektívnejšia, ale chladnejšia — a variant „Dáva to u vás zmysel, alebo som mimo?", ktorý podľa auditu *prekvapivo fungoval*, sa presúva z defaultu na variant pre citlivé segmenty (§7). Ak reply rate po mesiaci klesne pod 6,3 %, príčinu hľadaj tu a v §7.

---

## 0.0 Čo bolo nové vo v4.0 (08.09.2026)

**Rozhodnutie Martina:** *„píšeme veľa a o ničom — mail nech má iba 2 vety, možno 3."*

Čo sa mení oproti v3.4:

| | v3.4 (do 07.09.) | **v4.0 (od 08.09.)** |
|---|---|---|
| Dĺžka | 110 slov | **70 slov, 2–3 vety** |
| Prvá veta | ocenenie („máte poctivé fotky…") | **rovno postreh** |
| Predstavovacia veta | povinná, 14 slov | **zrušená** — rozsah nesie sloveso („vieme vám to zmodernizovať") |
| P.S. | výnimka | **zrušené** |
| Sociálny dôkaz | nepovinný | **v cold maile zrušený** (ostáva vo follow-upe) |
| Cena | nespomínala sa | **povinný signál** — „za rozumnú cenu", bez čísel |
| Quality check | 9 otázok | **10 otázok** |
| Opt-out veta | povinná | **zrušená** (v4.1, 08.09. poobede) |
| Podpis (appinara.sk) | „Gmail ho doplní sám" | **píše sa do tela** — Gmail ho NEDOPĹŇA (v4.1) |

**⭐ v4.1 (08.09.2026, poobede) — dve opravy po Martinovej spätnej väzbe a po kontrole schránky:**

1. **Opt-out veta zrušená** v cold maile (ostáva vo follow-upoch) — §4.
2. **Podpis:** guide do v4.0 tvrdil, že martin@appinara.sk pridáva HTML podpis automaticky.
   **Nepridáva.** Gmail Settings → Signature = „No signatures" (overené screenshotom 08.09.2026).
   Podpis sa píše do tela draftu. §4 a §10 opravené.

**Čo sa NEMENÍ:** pravidlá **H** (postreh doložený podstránkou) a **I** (over, či to už nemajú). V 70-slovnom maile tvorí postreh polovicu textu — nesprávny detail je tam ešte viditeľnejší než predtým. Skracujeme balast, nie research.

**Čo tým riskujeme (aby to bolo napísané):** audit z 01.09. (§0.1) ukázal, že všetky štyri pozitívne reakcie prišli na konkrétny postreh podaný teplo. Odstránením ocenenia z prvej vety sa o časť tej vrelosti pripravujeme — preto §8.5 prepísaná tak, aby teplo nieslo **rámovanie** (subjektom vety je ich zákazník, nie ich chyba). Ak reply rate po mesiaci klesne pod 6,3 %, príčinu hľadaj tu.

---

## 0.0.1 Čo bolo nové vo v3 (historické)
...
**3. Odmietnutia sú jednoslovné.** *„nie"*, *„Nie teraz"*, *„nemáme záujem"*. Nikto sa nedostane do tretieho odseku. Preto skracujeme — najprv na 110 slov (01.09.2026), od 08.09.2026 na **70 slov / 2–3 vety** (§4). Nie preto, že by dĺžka urážala, ale preto, že sa nečíta.
...
**D. Jedna konkrétna observácia, jeden nápad.** Nie tri odrážky s tromi features. Jedna vec, ktorú som si naozaj všimol → jeden nápad, ktorý to rieši. *(08.09.2026: P.S., ktoré bolo výnimkou z tohto pravidla, je zrušené — mail má odteraz jednu observáciu a jednu ponuku, bez alternatív.)*
...
## 4. Štruktúra dobrého mailu (2–3 vety, max 70 slov) ⭐ ZMENA 08.09.2026

> **K dĺžke:** strop je **70 slov** — od oslovenia po CTA otázku, **bez podpisu**.
> Vývoj stropu: 180 → 110 (01.09.2026) → **70 (08.09.2026, rozhodnutie Martina)**.
>
> Dôvod je stále §0.1: odmietnutia, ktoré nám chodia, sú jednoslovné. Aj pri 110 slovách
> sme písali tretí odsek, ktorý nikto nedočítal. Mail má odteraz **tri krátke odseky**:
> čo vidíme → čo s tým vieme spraviť a zhruba za koľko → otázka.
>
> **70 je strop, nie cieľ.** Ak to povieš na 45 slovách, mail je hotový.
>
> **Čo sa neskracuje NIKDY:** konkrétnosť postrehu. Krátime balast, nie obsah.
> Mail bez konkrétneho, doloženého postrehu je spam, aj keby mal 30 slov.

```
Predmet: [postreh konkrétne o ich biznise, 5–9 slov, bez slov „AI" a „chatbot"]

Dobrý deň,

[1 — POSTREH. JEDNA veta. Konkrétna vec z ICH webu, doložená podľa pravidla H,
     povedaná rovno a bez rozbehu.
     Ak je niečo naozaj nefunkčné, pomenuj to priamo:
       „tlačidlo Objednať sa na vašom webe nikam nevedie"
       „na stránke s cenníkom sa dá objednať len telefonicky, a to do 15:00"
     Ak nič pokazené NEMAJÚ, postreh znie „toto máte dobre spravené, len X sa stráca".
     ⚠ NEVYMÝŠĽAJ si chybu len preto, aby veta znela ostrejšie — to je presne
     ten scenár, ktorý nás spálil pri Hravosdrevom a Brezke (§0.1). Pravidlo H platí
     v plnom rozsahu a v 3-vetovom maile je nesprávny postreh EŠTE viditeľnejší,
     lebo tvorí polovicu textu.]

[2 — ČO KONKRÉTNE PONÚKAME. ⭐ PREPÍSANÉ 15.09.2026 — najdôležitejšia zmena v4.2.
     Jedna, nanajvýš dve vety. Príjemca musí po nich vedieť povedať, ČO SI U NÁS
     MÔŽE OBJEDNAŤ — nie „nejakú automatizáciu", ale konkrétnu vec.

     Tri povinné zložky, v tomto poradí:

     a) SLOVESO V PRVEJ OSOBE MNOŽNÉHO ČÍSLA, OZNAMOVACÍ SPÔSOB.
        ÁNO: „Postavíme vám…", „Spravíme vám…", „Pridáme vám na e-shop…",
             „Prepojíme vám…", „Zmodernizujeme vám…"
        NIE: „vieme vám postaviť", „vedeli by sme", „dalo by sa", „mohli by sme"
        Rozdiel je celá zmena v4.2: „vieme" je o NAŠEJ schopnosti, „postavíme"
        je PONUKA. Kondicionál mail zneistí a zaberie slová navyše (§8).

     b) POMENOVANÁ VEC, nie opis mechanizmu.
        ÁNO: „chatbota", „rezervačný systém", „online objednávanie", „nový web",
             „poradcu veľkostí", „cenovú kalkulačku", „jednu schránku na dopyty"
        NIE: „asistenta, ktorý by zodpovedal bežné otázky a zvyšok by vám poslal"
        Slová „AI", „chatbot", „automatizácia" sú v TELE mailu POVOLENÉ a často
        najzrozumiteľnejšie. V PREDMETE ostávajú zakázané (§5) — tam predávame
        vyriešený problém, tu predávame vec.
        Za pomenovanú vec smie ísť JEDNA krátka vedľajšia veta, čo to spraví
        pre ICH zákazníka („…ktorý odpovie aj o polnoci"). Nie dve.

     c) CENOVÝ SIGNÁL — povinný, bez čísla.
        Povolené: „za rozumné peniaze", „za výhodnú cenu", „nasadenie pár týždňov",
        „nie je to drahé ani zdĺhavé".
        ZAKÁZANÉ: konkrétne sumy, %, ROI, „od 990 €" (pravidlo B platí ďalej).

     Samostatná predstavovacia veta („V Appinare staviame weby, aplikácie a AI
     integrácie…") sa od 08.09.2026 UŽ NEPOUŽÍVA — kto sme, povie podpis.]

[3 — OTÁZKA NA ZÁUJEM. ⭐ PREPÍSANÉ 15.09.2026.
     Jedna priama otázka z rotácie §7, na ktorú sa dá odpovedať slovom „áno"
     alebo „nie". Default: „Máte o to záujem?"
     NEPÝTAME sa na termín hovoru, na 15 minút ani na to, či sme mimo —
     pri prvom kontakte zisťujeme JEDINÚ vec: či je o to záujem.
     (Opt-out veta sa od 08.09.2026 NEPÍŠE — viď nižšie.)]

[PODPIS — POZOR, OPRAVENÉ 08.09.2026 (overené v Gmail Settings):
   martin@appinara.sk → Settings → Signature = „No signatures".
                        ŽIADNY automatický podpis sa nepridáva. Do tela draftu
                        preto PATRÍ textový podpis, presne takto, dva riadky:
                        S pozdravom,
                        Martin Saraka | Appinara s.r.o. | appinara.sk
                        (Predchádzajúca verzia guidu tvrdila opak — bola to chyba;
                        kvôli nej odchádzali maily 03.09. a 06.09. bez podpisu,
                        kým sa nedopĺňal ručne pri každom odoslaní.)
   gmail (appinarasolutions@gmail.com) → textový podpis:
                        S pozdravom,
                        Martin Saraka
                        Appinara s.r.o. | appinara.sk | +421 917 566 722]
```

### ⭐ Vzor (Naša Bublinka) — v4.1 vs. v4.2, tá istá firma

**Takto to vyzeralo vo v4.1 (opisné a opatrné):**

> Sami na stránke s obuvou píšete, že pri výbere treba zohľadniť nielen veľkosť, ale aj
> tvar chodidla — poradiť s tým však viete len dovtedy, kým máte v Galérii otvorené.
>
> ~~Vieme vám na e-shop pridať poradcu, ktorý sa rodiča aj o desiatej večer opýta na vek
> a tvar chodidla a odporučí konkrétny model.~~ Pár týždňov práce a za rozumné peniaze.
>
> ~~Mám poslať, ako by to vyzeralo u vás?~~

**Takto to vyzerá vo v4.2 (priamo):**
...
> tvar chodidla — poradiť s tým však viete len dovtedy, kým máte v Galérii otvorené.
>
> Postavíme vám na e-shop poradcu veľkostí, ktorý sa rodiča aj o desiatej večer opýta
> na vek a tvar chodidla a odporučí konkrétny model. Pár týždňov, za rozumné peniaze.
>
> Máte o to záujem?
>
> S pozdravom,
...
| | v4.1 | v4.2 |
|---|---|---|
| Sloveso | „Vieme vám pridať" — hovorí o nás | „Postavíme vám" — je to ponuka |
| Predmet ponuky | „poradcu, ktorý…" (opis) | „poradcu veľkostí" (pomenovaná vec) |
| Záver | „Mám poslať, ako by to vyzeralo?" | „Máte o to záujem?" |
| Dĺžka tela | 63 slov | **61 slov** — priamejšie a zároveň kratšie |

**Čo ostalo nedotknuté:** prvý odsek. Je to ICH vlastná veta z ich vlastnej podstránky
(pravidlo H splnené bez námahy), medzera je reálna a overená (kamenná predajňa má
otváracie hodiny) a subjektom je rodič, nie majiteľ. Priamosť v4.2 sa týka odsekov 2 a 3 —
prvý odsek sa nezostručňuje ani nepriostruje.

*(Príklad je z vetvy martin@appinara.sk — preto dvojriadkový podpis; v gmail vetve má
podpis tri riadky aj s telefónom, viď šablóna vyššie.)*

### ⭐ P.S. — ZRUŠENÉ (08.09.2026)

P.S. bolo vo v3.3 default, vo v3.4 výnimka a od v4.0 sa **nepoužíva vôbec**.
Pri 70 slovách naň nie je miesto a „otvorené dvere" už nesie sloveso v druhom odseku
(„vieme vám to zmodernizovať" hovorí to isté v troch slovách).

### ⭐ Opt-out veta — ZRUŠENÁ v cold maile (08.09.2026)

**Rozhodnutie Martina 08.09.2026:** opt-out veta („Ak vás podobné maily nezaujímajú,
stačí odpísať a viac sa neozvem.") sa v cold maile **už nepoužíva**. Pri 3-vetovom
maile zaberala celú štvrtinu textu a znela defenzívne — mail sa ňou ospravedlňoval
za to, že vôbec prišiel.

Platí od 08.09.2026 pre obe vetvy. Telo končí CTA otázkou, pod ňou podpis.

*(Historicky: zavedená 04.08.2026, povinná do 07.09.2026. Kto číta staršie drafty
v schránke, nájde ju tam — pri prepise sa odstraňuje.)*

**Vo follow-upoch ostáva** — tam už ide o druhý/tretí dotyk a odovzdanie kontroly
má zmysel (§11).
...
Kým nemáme reálne case studies s permission, sociálny dôkaz nahrádza **konkrétnosť observácie** (odsek 1 šablóny) a **kvalita nápadu** (odsek 2 šablóny).

> **⭐ ZMENA 08.09.2026 — v cold maile sa sociálny dôkaz už nepoužíva.** Pri strope 70 slov naň nie je miesto a je to druhá vec, ktorá ide von pri škrtaní (§9). Táto sekcia platí ďalej pre **follow-upy** (§11, kde je priestor na jeden nový uhol) a pre odpovede na reakcie prospektov, kde je odkaz na blog alebo named klient často to najsilnejšie, čo máme.
...
**⭐ PREPÍSANÉ 15.09.2026 (v4.2).** Pri prvom kontakte zisťujeme JEDINÚ vec: **či je o to
záujem.** Nie kedy majú čas, nie či im smieme niečo poslať, nie či sme mimo. Preto sú
všetky CTA, ktoré predpokladali hovor alebo ukážku, zrušené — pýtali si od príjemcu
rozhodnutie o kalendári skôr, než sa rozhodol, či ho ponuka vôbec zaujíma.

Vyber **jednu** podľa situácie, nie dokola tú istú:

1. „Máte o to záujem?" *(DEFAULT — najkratšia a najpriamejšia, 4 slová)*
2. „Zaujíma vás to?" *(ešte kratšia, keď je mail na hrane 70 slov)*
3. „Chcete, aby som vám poslal konkrétnu ponuku?" *(keď je ponuka jasne ohraničená a vieme ju nacenit)*
4. „Máte záujem, alebo to u vás nie je téma?" *(explicitne otvára dvere na „nie" — dobré pre malé rodinné firmy)*
5. „Dáva to u vás zmysel? Ak áno, ozvite sa." *(najmäkšia — pre CITLIVÉ segmenty: psychológia, psychiatria, pohrebné služby, onkológia)*

**Pravidlo:** nikdy nie tá istá CTA dvakrát v tom istom dennom dávkovaní 10 mailov.

**Zrušené 15.09.2026** (nepoužívať, aj keď ich nájdeš v starších draftoch):
~~„Hodí sa vám tento alebo budúci týždeň?"~~ · ~~„Ukázal by som vám to priamo na vašom webe. Kedy sa vám to hodí?"~~ · ~~„Máte 15 minút budúci týždeň?"~~ · ~~„Mám poslať, ako by to vyzeralo u vás? Bez hovoru."~~ · ~~„Ak vás to zaujme, rád vám k tomu poviem viac…"~~

> **Poznámka k variante 6 zo starej rotácie.** „Dáva to u vás zmysel, alebo som mimo?"
> bola podľa auditu §0.1 *prekvapivo funkčná* a je škoda ju stratiť úplne — preto z nej
> ostáva zmäkčená podoba ako variant 5, ale **len pre citlivé segmenty**. V bežnom maile
> je to okolkovanie: pýta sa na náš úsudok namiesto ich záujmu.
>
> *(Opt-out veta je v cold maile zrušená od 08.09.2026 — CTA je posledný riadok tela,
> pod ňou ide rovno podpis. Vo follow-upoch opt-out ostáva, §11.)*
...
## 8.5. ⭐ Teplý tón v krátkom maile — prepísané 08.09.2026

Cieľ sa nemení: aby príjemcovi po prečítaní napadlo *„tento chlapík si naozaj pozrel môj web a chce mi pomôcť"*, nie *„tento cudzí človek mi vymenoval, čo mám zlé"*.

**Čo sa zmenilo (08.09.2026):** teplo sa už **nerobí ocenením na začiatku** — na to pri 70 slovách nie je miesto. Robí sa **rámovaním postrehu** a **odovzdaním kontroly na konci**. Ten istý fakt sa dá povedať tromi spôsobmi a len jeden z nich je súd:

| | |
|---|---|
| ❌ Súd o ich práci | „Rezervačný systém máte zle vyriešený." |
| ❌ Ocenenie ako rozohriatie (12 slov navyše) | „Máte krásne fotky jedál — o to viac je škoda, že rezervácia ide len cez telefón." |
| ✅ Fakt + dôsledok pre nich | „Rezervovať sa u vás dá len telefonicky — hosť, ktorý pozerá web o 22:00, nemá kam kliknúť." |

Tretia varianta je najkratšia **aj** najteplejšia, lebo hovorí o **hosťovi**, nie o majiteľovi. To je celý trik v4.0: **subjektom vety je ich zákazník, nie ich chyba.**

**Rob:**

- **Píš o ich zákazníkovi, nie o ich webe.** „Hosť nemá kam kliknúť" > „chýba vám rezervačný formulár". Fakt je rovnaký, ale prvé je pozorovanie zvonku, druhé je nález audítora.
- **Predpokladaj kompetenciu.** Píšeš zaneprázdnenému majiteľovi, ktorý to vie robiť — len na niečo nemal čas alebo ruky. Nie začiatočníkovi, ktorý spravil chybu.
- **Zakonči priamou otázkou, nie tlakom.** ⭐ PREPÍSANÉ 15.09.2026. Otázka „Máte o to záujem?" (§7) je priama, ale nie nátlaková — dá sa na ňu odpovedať jedným slovom v oboch smeroch a nepýta si od príjemcu čas ani kalendár. To je presne to odovzdanie kontroly, ktoré predtým niesla opt-out veta. Ak je segment citlivý (psychológia, psychiatria, pohrebné služby), použi variant 5 zo §7.

- **⭐ Priamosť sa týka odsekov 2 a 3, nie odseku 1.** Toto je najčastejší spôsob, ako sa dá v4.2 pokaziť. Priamo sa hovorí o TOM, ČO PONÚKAME („Postavíme vám rezervačný systém") a o TOM, ČO CHCEME VEDIEŤ („Máte o to záujem?"). Postreh v prvom odseku ostáva pozorovaním zvonku o ICH zákazníkovi. Zostručniť prvý odsek na „Nemáte online rezerváciu." je krok späť, nie vpred — je to nález audítora, nie postreh človeka.
- **Ocenenie použi, LEN ak je samo osebe postrehom.** Ak si našiel niečo, čo robia dobre a čo priamo súvisí s medzerou, smie to byť veta 1 — ale musí niesť aj ten postreh, nie stáť pred ním. Napr.: *„Šesť jazykových mutácií máte poctivo prepísaných, ale rezervačný formulár ostal len po slovensky."* To je jedna veta, nie dve.
- **Ak nič pokazené nemajú, povedz to.** Nie každá firma má rozbitý web. Vtedy postreh znie *„toto máte spravené dobre, len X sa stráca"* — a je to stále postreh, nie ocenenie na rozohriatie. Vymýšľať si chybu, aby veta znela ostrejšie, je porušenie pravidla H (§0.1, Hravosdrevom a Brezka).

**Nerob:**

- **Ocenenie ako rozohriatie.** Veta, ktorá len chváli a nenesie postreh, je balast — ide von prvá.
- Prehnané lichôtky („fantastický web!", „ste najlepší v odbore") — znie falošne.
- Servilnosť („ospravedlňujem sa, že ruším", „viem, že si ma nevšimnete") — teplo nie je poníženosť. Píšeš ako rovný rovnému.
- **Vetu, ktorá súdi ich prácu.** Ak sa v prvej vete objaví „máte zle", „je zastarané", „nefunguje vám" → prepíš na fakt + dôsledok pre zákazníka.
- Falošnú vrelosť („dúfam, že sa máte skvele!") — teplo je v konkrétnosti a rešpekte, nie v prázdnych frázach.

**Test (nezmenený):** predstav si, že príjemca je tvoj známy, ktorého si stretol na akcii. Povedal by si mu to takto do očí? *„Hej, všimol som si, že sa u teba nedá rezervovať online — viem to spraviť"* je presne ono. *„Hej, máš zastaraný web"* nie je.

---

## 9. Quality check pred odoslaním (10 otázok) ⭐ ROZŠÍRENÉ 08.09.2026

Pred kliknutím Send si prejdem mail a odpoviem na týchto 10. *(Vývoj počtu: 7 do 31.08.2026 → 9 od 01.09.2026 (§0.1) → 10 od 08.09.2026, pribudla kontrola cenového signálu. Do promptov úloh sa počet NEPÍŠE — berie sa odtiaľto.)*
...
5. **⭐ Pomenovaná ponuka (PREPÍSANÉ 15.09.2026):** Vedel by príjemca po prečítaní druhého odseku povedať jednou vetou, **čo si u nás môže objednať**? Je tam POMENOVANÁ VEC (chatbot, rezervačný systém, nový web, kalkulačka), alebo len opis mechanizmu? A je sloveso oznamovacie („postavíme vám"), nie podmieňovacie („vedeli by sme")? Ak je tam kondicionál alebo „vieme vám" → prepíš.
6. **Tón:** Znie to ako od človeka, alebo ako od marketing nástroja? Skús nahlas — ak ti je trápne to čítať, prerobiť.
   **⭐ Teplo (§8.5, prepísané 08.09.2026):** Je subjektom prvej vety ich **zákazník alebo fakt**, nie ich chyba? („hosť nemá kam kliknúť" ÁNO — „máte to zle spravené" NIE.) Povedal by som to tak známemu do očí? *(Pozor: požiadavka „otvor ocenením PRED medzerou" bola 08.09.2026 zrušená — na 70 slov nie je miesto. Teplo sa robí rámovaním, nie chválou navyše.)*
7. **⭐ CTA (PREPÍSANÉ 15.09.2026):** Je posledná veta **priama otázka na záujem** zo §7, na ktorú sa dá odpovedať „áno" alebo „nie"? Nepýtam sa náhodou na termín hovoru, na 15 minút, alebo na to, či som mimo? Tie varianty sú zrušené. A je CTA iná ako v predošlom maile dnes?
...
10. **⭐ Cenový signál (NOVÉ 08.09.2026):** je v maile veta, ktorá naznačí, že to nie je drahé — „za rozumné peniaze", „za výhodnú cenu", „nasadenie pár týždňov", „nie je to drahé ani zdĺhavé"? Bez nej si príjemca domyslí, že je to mimo jeho rozpočet, a neodpíše. **S konkrétnou sumou, % alebo ROI → von** (pravidlo B platí ďalej: cenu naznačujeme, nesľubujeme).

**A na záver kontrola dĺžky (⭐ ZMENA 08.09.2026):** má telo mailu (bez podpisu) **max 70 slov** a **nanajvýš 3 krátke odseky**? Slová počítam PRED uložením, nezaokrúhľujem nahor.

Ak je mail dlhší, škrtám v tomto poradí:

1. **Ocenenie, ktoré nenesie postreh** („máte pekné fotky", „poctivo spracované menu")
2. **Sociálny dôkaz** (§6 — v 3-vetovom maile sa už nepoužíva)
3. **Druhá veta v odseku 2** (ponuka sa dá skoro vždy povedať jednou vetou)
4. **Prívlastky a rozbehy** („rád by som", „napadlo mi, že by možno")

**Nikdy neškrtám:** konkrétnosť postrehu (odsek 1) a podpis. Mail bez doloženého postrehu je spam, aj keby mal 30 slov. *(08.09.2026: opt-out veta zo zoznamu vypadla — je zrušená, viď §4.)*

Mail, ktorý neprejde všetkých 10, **neposielame** — radšej žiadny mail ako zlý mail. Reputácia príjemcu (a domény) je dlhodobo cennejšia.
...
- **⚠ OPRAVENÉ 08.09.2026 — schránka martin@appinara.sk NEMÁ žiadny automatický podpis.** Overené priamo v Gmail Settings → General → Signature: **„No signatures"**. Tvrdenie z 09.08.2026 (že Gmail podpis doplní sám) bolo nesprávne a stálo nás dva behy mailov bez podpisu (03.09., 06.09. — dopĺňal sa ručne pri každom odoslaní). **Draft v tejto schránke MUSÍ mať v tele podpis:** `S pozdravom,` / `Martin Saraka | Appinara s.r.o. | appinara.sk`. Ak si niekedy podpis v Settings nastavíte, zmeňte najprv tento riadok a až potom generátor draftov.
...
- **⭐ 08.09.2026 — prompty zosúladené s v4.0.** Prompty oboch research úloh boli 08.09.2026 prepísané na **max 70 slov / 2–3 vety** + povinný cenový signál. Follow-up úlohy dedia dĺžku odtiaľto. Pri akomkoľvek konflikte medzi promptom a guidom **vyhráva guide**.
- **⭐ 15.09.2026 — prompty zosúladené s v4.2.** Obidve research úlohy (`appinara-research-prospects` pre gmail vetvu aj `najdi-15-slovenskych-firiem-pre-appinara-s--r--o` pre weby vetvu) majú prepísaný krok „NAPÍŠ DRAFT", odsek 2 a odsek 3: oznamovacie sloveso, pomenovaná ponuka, priama otázka na záujem. **Follow-upy (§11) sa touto zmenou NEMENIA** — tam je kontext už postavený a opt-out ostáva.
- **⭐ Pozor pri daily-send úlohách.** V schránkach ležia drafty napísané ešte podľa v4.1 (nepriame CTA typu „Mám poslať, ako by to vyzeralo u vás?"). Daily-send ich **neprepisuje** — odošle ich tak, ako sú. Je to v poriadku; neznamená to, že sa v4.2 neuplatnila. Nové drafty od 15.09.2026 už majú priamu CTA.
- **⚠ Guide needituj z dvoch behov naraz.** 08.09.2026 ho súbežne prepisovali dve session (§4 z jednej, §8.5 z druhej) a súbor chvíľu tvrdil 70 slov v §4 a 110 v §9. Ak meníš guide, rob to v jednej session a ostatné outreach úlohy dovtedy pozastav.
...
- **⭐ Dĺžka (08.09.2026): max 60 slov.** Follow-up je kratší než cold mail — príjemca už kontext má, netreba ho stavať znova. Sociálny dôkaz (§6) je tu povolený, ak sa zmestí a je reálny; je to jediné miesto v sekvencii, kde má priestor.
...
> Dobrý deň,
>
> vraciam sa k môjmu mailu ohľadom [konkrétny nápad/postreh z M]. Napadol mi k tomu ešte jeden uhol: [JEDEN nový, konkrétny bod — nie zopakovanie, nie druhá featura].
>
> [CTA z rotácie §7 — iná než v úvodnom maile.] [Opt-out veta.]

**Podpis vo follow-upe — rovnaké pravidlo ako v §4 a §10 (OPRAVENÉ 08.09.2026):**

- **martin@appinara.sk** → textový podpis POVINNE, schránka žiadny nedopĺňa („No signatures" v Settings): `S pozdravom,` / `Martin Saraka | Appinara s.r.o. | appinara.sk`
- **gmail** → „Pekný deň, / Martin Saraka / Appinara s.r.o. | appinara.sk | +421 917 566 722"
...
*v4.0 — 08.09.2026 (rozhodnutie Martina: maily boli „dlhé a o ničom" — strop znížený zo 110 na **70 slov / 2–3 vety**; §4 prepísaná na tri odseky „čo vidíme → čo s tým vieme spraviť a za koľko → otázka"; samostatná predstavovacia veta a P.S. ZRUŠENÉ, rozsah ponuky nesie sloveso v druhom odseku; nový povinný **cenový signál** bez čísel; §8.5 prepísaná — teplo sa robí rámovaním (subjektom vety je ich zákazník, nie ich chyba), nie ocenením navyše; quality check rozšírený z 9 na 10 otázok. **Pravidlá H a I sa NEMENIA** — v kratšom maile je nesprávny postreh ešte viditeľnejší, lebo tvorí polovicu textu.)*
