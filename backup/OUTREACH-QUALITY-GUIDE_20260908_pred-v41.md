...
## 0. Čo je nové vo v4.0 (08.09.2026) — čítaj PRVÉ
...
## 0.0 Čo bolo nové vo v3 (historické)
...
> **K dĺžke:** strop je **70 slov** — od oslovenia po opt-out vetu, **bez podpisu**.
...
[2 — ČO S TÝM VIEME SPRAVIŤ. Jedna, nanajvýš dve vety. Konkrétne, čo postavíme,
     + rozsah a cenový signál.
     Povolené o cene: „za rozumné peniaze", „za výhodnú cenu", „nasadenie pár týždňov",
     „nie je to drahé ani zdĺhavé".
     ZAKÁZANÉ: konkrétne sumy, %, ROI, „od 990 €" (pravidlo B platí ďalej).
     Rozsah firmy sa nesie SLOVESOM v tejto vete — „vieme vám to zmodernizovať",
     „vieme vám na e-shop pridať", „vieme vám to prepojiť". Samostatná predstavovacia
     veta („V Appinare staviame weby, aplikácie a AI integrácie…") sa od 08.09.2026
     UŽ NEPOUŽÍVA — na 70 slov je to 11 slov za nič a kto sme, povie podpis.]

[3 — CTA z rotácie §7 + opt-out veta. Pokojne v jednom riadku:
     „Dáva to zmysel, alebo som mimo? Ak nie, stačí krátke nie a už sa neozvem."]

[PODPIS — POZOR, líši sa podľa schránky (§10):
   martin@appinara.sk → ŽIADNY textový podpis. Telo končí riadkom [3].
                        Schránka pridá HTML podpis (logo + Appinara s. r. o.
                        + telefón + appinara.sk) sama. Ak ho napíšeš do tela,
                        bude v maile DVAKRÁT.
...
>
> Mám poslať, ako by to vyzeralo u vás? Ak vás to nezaujme, stačí krátke nie a už sa neozvem.

**Prečo funguje:** postreh je ICH vlastná veta z ich vlastnej podstránky (pravidlo H
splnené bez námahy), medzera je reálna a overená (kamenná predajňa má otváracie hodiny),
ponuka je konkrétna, cena naznačená bez čísla, CTA nevyžaduje hovor.
...
### Opt-out veta (od 04.08.2026, platí ďalej)

Každý cold draft (obe vetvy) končí opt-out vetou — dáva príjemcovi kontrolu
a je to fér aj právne čistejšie:

> „Ak vám takéto maily nesedia, stačí krátke nie a už sa neozvem."

Smie sa skrátiť („Ak nie, stačí krátke nie a už sa neozvem.") a smie splynúť
s CTA do jedného riadku. Vynechať sa NESMIE. Tón podľa §8.5: vecné odovzdanie
kontroly, žiadna servilnosť.
...
> **⭐ 08.09.2026 — pri 3-vetovom maile uprednostni krátke varianty (4, 5, 6).** Varianta 3 je 20 slov a zožerie tretinu mailu; varianty 1 a 2 predpokladajú hovor, čo je pri prvom kontakte väčšie trenie. Varianta 6 („Dáva to u vás zmysel, alebo som mimo?") navyše preberá úlohu zrušeného P.S. — otvára dvere tomu, aby prospekt povedal, čo ho tlačí naozaj.
>
> CTA a opt-out veta smú splynúť do jedného riadku: *„Dáva to zmysel, alebo som mimo? Ak nie, stačí krátke nie a už sa neozvem."*
...
- **Zakonči odovzdaním kontroly.** CTA č. 6 („Dáva to u vás zmysel, alebo som mimo?") a opt-out veta robia spolu presne to, čo predtým robil láskavý záver — dávajú im voľnosť odmietnuť bez zlého pocitu.
...
5. **⭐ Rozsah:** Vie príjemca z mailu, čo preňho vieme spraviť? *(08.09.2026: predstavovacia veta a P.S. sú zrušené — rozsah nesie SLOVESO v druhom odseku („vieme vám to zmodernizovať / pridať / prepojiť") a podpis. Nemusí zaznieť celé portfólio, musí zaznieť konkrétna ponuka.)*
...
**Nikdy neškrtám:** konkrétnosť postrehu (odsek 1) a opt-out vetu. Mail bez doloženého postrehu je spam, aj keby mal 30 slov.
...
**Podpis vo follow-upe — rovnaké pravidlo ako v §4 a §10:**

- **martin@appinara.sk** → žiadny textový podpis, telo končí CTA a opt-out riadkom (schránka pridá HTML podpis sama)
